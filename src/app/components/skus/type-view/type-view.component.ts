...
export class TypeViewComponent implements OnInit {
    ...
    fetchProducts() {
        ...
        let url = environment.API_URL + "/fetch/type/" + this.type._id;
    ...
    edit() {
        this.router.navigateByUrl("skus/type-edit/" + this.typeId);
    }

    exit() {
        this.router.navigateByUrl("/skus/manage-skus?tab=types");
    }
